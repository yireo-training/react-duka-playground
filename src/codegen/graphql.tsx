...
export type SearchQuery = (
  ...
  & { products: Maybe<(
    ...
    & { items: Maybe<Array<Maybe<(
      { __typename?: 'VirtualProduct' }
      & Pick<VirtualProduct, 'id' | 'name' | 'url_key' | 'sku' | 'created_at' | 'stock_status' | 'country_of_manufacture' | 'fashion_material'>
      & { description: Maybe<(
        { __typename?: 'ComplexTextValue' }
        & { __html: ComplexTextValue['html'] }
      )>, image: Maybe<(
      ...
      { __typename?: 'SimpleProduct' }
      & Pick<SimpleProduct, 'id' | 'name' | 'url_key' | 'sku' | 'created_at' | 'stock_status' | 'country_of_manufacture' | 'fashion_material'>
      & { description: Maybe<(
        { __typename?: 'ComplexTextValue' }
        & { __html: ComplexTextValue['html'] }
      )>, image: Maybe<(
      ...
      { __typename?: 'DownloadableProduct' }
      & Pick<DownloadableProduct, 'id' | 'name' | 'url_key' | 'sku' | 'created_at' | 'stock_status' | 'country_of_manufacture' | 'fashion_material'>
      & { description: Maybe<(
        { __typename?: 'ComplexTextValue' }
        & { __html: ComplexTextValue['html'] }
      )>, image: Maybe<(
      ...
      { __typename?: 'BundleProduct' }
      & Pick<BundleProduct, 'id' | 'name' | 'url_key' | 'sku' | 'created_at' | 'stock_status' | 'country_of_manufacture' | 'fashion_material'>
      & { description: Maybe<(
        { __typename?: 'ComplexTextValue' }
        & { __html: ComplexTextValue['html'] }
      )>, image: Maybe<(
      ...
      { __typename?: 'GroupedProduct' }
      & Pick<GroupedProduct, 'id' | 'name' | 'url_key' | 'sku' | 'created_at' | 'stock_status' | 'country_of_manufacture' | 'fashion_material'>
      & { description: Maybe<(
        { __typename?: 'ComplexTextValue' }
        & { __html: ComplexTextValue['html'] }
      )>, image: Maybe<(
      ...
      { __typename?: 'ConfigurableProduct' }
      & Pick<ConfigurableProduct, 'id' | 'name' | 'url_key' | 'sku' | 'created_at' | 'stock_status' | 'country_of_manufacture' | 'fashion_material'>
      & { description: Maybe<(
        { __typename?: 'ComplexTextValue' }
        & { __html: ComplexTextValue['html'] }
      )>, image: Maybe<(
